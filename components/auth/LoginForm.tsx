...
export const LoginForm = () => {
  ...
  const handleEmailLogin = async (e: React.FormEvent) => {
    ...
    if (error) {
      // HCI: Heuristic 9 — specific human error messages
  ...
  return (
    <div className="w-full max-w-md mx-auto p-8 rounded-2xl bg-bg-surface border border-border shadow-lg">
      <div className="text-center mb-8">
        <h1 className="text-2xl font-bold text-text-1 mb-2">Welcome back</h1>
        <p className="text-text-2">Sign in to your account</p>
      </div>
      ...
      <form onSubmit={handleEmailLogin} className="flex flex-col gap-5">
        ...
        <Button type="submit" isLoading={loading} disabled={!email || !password}>
          Sign In
        </Button>
      </form>

...
export const metadata: Metadata = {
  title: 'Login - Study Flow',
  description: 'Sign in to your Study Flow account',
}

export default function LoginPage() {
  return (
    <main className="min-h-screen flex flex-col items-center justify-center p-4 bg-bg-app" aria-label="Login page">
